...
import com.adamin.demo.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public MyRealm myRealm(){
        ...
        logger.info("------自定义realm register success----");
        return  realm;
    }
...
// 将自定义realm加进来
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SessionsSecurityManager securityManager) {
        ...
        //lucence测试，放行
        filterChainMap.put("/lucence", "anon");

        // “/user/admin” 开头的需要身份认证
        filterChainMap.put("/member/admin*", "authc");
        // “/user/student” 开头的需要角色认证，是“admin”才允许
        filterChainMap.put("/member/student*/**", "roles[admin]");
        // “/user/teacher” 开头的需要权限认证，是“user:create”才允许
        filterChainMap.put("/member/teacher*/**", "perms[\"user:create\"]");
//        filterChainMap.put("/member/test*/**", "perms[\"student:create\"]");
